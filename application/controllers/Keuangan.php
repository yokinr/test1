...
class Keuangan extends CI_Controller {
	...
	function laporan_keuangan()
	{
		...
		$data = array(
			...
			'load' => $this->encryption->encrypt('laporan_keuangan'),
			'tombol' => '',
		);
		$this->load->view('templates', $data, FALSE);
	}

	function laporan_rombel()
	{
		$data = array(
			'title' => 'Laporan Keuangan',
			'load' => $this->encryption->encrypt('laporan_keuangan_rombel'),
			'tombol' => ''
		);
		$this->load->view('templates', $data, FALSE);
	}

	function detail_rombel()
	{
		$data = array(
			'title' => 'Laporan Keuangan',
			'load' => $this->encryption->encrypt('detail_keuagan_rombel'),
			'tombol' => ''
		);
		$this->load->view('templates', $data, FALSE);
	}
